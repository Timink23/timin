...
static void test_alpha_display() {
    ...
    while (1) {
        ...
        if (time1 < 10)
        {
            displaybuffer[0] = alphafonttable[digit1];
            displaybuffer[1] = alphafonttable[' '];
        }
        else
        {
            displaybuffer[0] = alphafonttable[digit1];
            displaybuffer[1] = alphafonttable[digit2];
        }



        displaybuffer[2] = alphafonttable[' '];
        displaybuffer[3] = alphafonttable[' '];
...
void app_main(void) {
    ...
    xTaskCreate(test_alpha_display, "display task", 1024 * 2, NULL, configMAX_PRIORITIES - 2, NULL);
